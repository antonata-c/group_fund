...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--collects", type=int, default=10, help="Количество сборов на пользователя"
        )
        parser.add_argument(
            "--payments", type=int, default=15, help="Количество платежей на сбор"
        )
    ...
    def handle(self, *args, **kwargs):
        ...
        for user in users:
            collects = CollectFactory.create_batch(num_collects_per_user, user=user)
